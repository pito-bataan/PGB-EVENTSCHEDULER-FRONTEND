  ...
  return (
    <div className="min-h-screen bg-gray-50/50 p-8">
      <div className="max-w-[1600px] mx-auto space-y-6">
        {/* Header */}
        <div>
          <h1 className="text-2xl font-semibold tracking-tight text-gray-900">All Booked Events</h1>
          <p className="text-sm text-muted-foreground mt-1">View all location bookings and event details</p>
        </div>
